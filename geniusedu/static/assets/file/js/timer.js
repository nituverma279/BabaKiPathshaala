...
timer.update = function() {
  ...
  timer.days.innerHTML = timer.getTimeRemaining(timer.times.day, 15);
  timer.hours.innerHTML = timer.getTimeRemaining(timer.times.hour, 07);
  timer.minutes.innerHTML = timer.getTimeRemaining(timer.times.minute, 30);
